...
// Casos de uso mínimos (7 itens): 3 usuários, 3 recursos (livro+3cap, revista, midia), 1 empréstimo livro p/ aluno etc.
private void seed() {
...
// Empréstimo inicial: Livro para Aluno
bib.emprestar("R1", "U1");
}
}